...
public class Systems extends BaseModel implements Serializable {
    ...
    public Systems(Long id, int name, long organization, boolean isAvailable, Date expectedFreeTime, Integer minimumMinutes, double minuteRate, boolean enabled) {
        this.id = id;
        this.name = name;
