...
public class MembershipServiceImpl implements MembershipService {
    ...
    public void saveMembershipType(MembershipTypes membershipTypes) {
        if (membershipTypes.getId() == null) {
            this.membershipTypesDao.persist(membershipTypes);
        } else {
            this.membershipTypesDao.merge(membershipTypes);
        }
    }
    ...
    public void saveMembershipDiscounts(MembershipDiscounts membershipDiscounts) {
        if (membershipDiscounts.getId() == null) {
            this.membershipDiscountsDao.persist(membershipDiscounts);
        } else {
            this.membershipDiscountsDao.merge(membershipDiscounts);
        }
    }

    @Override
    public MembershipDiscounts getMembershipDiscountsById(Long id) {
        return this.membershipDiscountsDao.find(id);
    }
    ...
    public void saveMembership(Memberships memberships, Organization org, String cashier) {
        ...
        this.membershipsDao.persist(memberships);
...
//    }
     ...
     */
    @Override
    public Memberships getMembershipsById(Long id) {
        return this.membershipsDao.find(id);
    }
