 ...
 * @author intesar
 */
public class AdminRoleCheckFilter implements AjaxFilter {
    ...
    public Object doFilter(Object obj, Method method, Object[] params, AjaxFilterChain chain) throws Exception {
        try {
            ...
            if (roleCheckUtil.isUserGroupAdmin() || roleCheckUtil.isUserGroupOwner()) {
    ...
    protected static final Log logger = LogFactory.getLog(AdminRoleCheckFilter.class);
}
